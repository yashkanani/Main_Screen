    ...
    MouseArea
    {
        ...
        onReleased:
        {
            ...
            if(text_name=="Radio")
            {
               ...
               root.changeScreen("RadioMainScreen.qml")

            }
            if(text_name=="Media Player")
            {
               root.changeScreen("MediaScreen.qml")


            }
            if(text_name=="Phone")
            {
               root.changeScreen("PhoneDialPadScreen.qml")


            }
            if(text_name=="Setting")
            {
